...
const Balls = () => {
  ...
  return (
      ...
      <ImageBackground style={styles.image} source={require("./assets/AppStart.png")}>
        ...
        <Image source={require("./assets/sneakers.png")} style={styles.category2image} />
        <View style={{width:13 ,flexDirection:"row"}} ></View>
    <Text style={{fontSize:32,color:"white",fontWeight:"bold",fontStyle:"italic" }}>Footwear Section</Text>
          </View>
