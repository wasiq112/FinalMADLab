...
const Balls = () => {
  ...
  return (
      ...
      <ImageBackground style={styles.image} source={require("./assets/AppStart.png")}>
        ...
        <Image source={require("./assets/icons8-cricket-bat-55.png")} style={styles.category2image} />

          <Text style={{fontSize:47,color:"white",fontWeight:800,fontStyle:"italic" }}>Bats Section</Text>
          </View>
